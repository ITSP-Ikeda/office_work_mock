...
class ParkingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parking" do
    assert_difference("Parking.count") do
      post parkings_url, params: { parking: { parking_name: @parking.parking_name, payment_destination_id: @parking.payment_destination_id } }
    end
  ...
  test "should update parking" do
    patch parking_url(@parking), params: { parking: { parking_name: @parking.parking_name, payment_destination_id: @parking.payment_destination_id } }
